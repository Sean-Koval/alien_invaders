...
class Scoreboard():
    ...
    def prep_high_score(self):
        """
        Turn the igh score in to a rendered image
        """

        high_score = int(round(self.stats.high_score), -1)
        high_score_str = "{:,}".format(high_score)
        self.prep_high_score = self.font.render(high_score_str, True, self.text_color, self.game_settings.bg_color)
    ...
    def prep_ships(self):
        ...
        self.ships = Group()
        for ship_number in range(self.sats.ships_left()):
